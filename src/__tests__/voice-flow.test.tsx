...
describe('Voice Flow Tests', () => {
  ...
  describe('WebRTC Voice Interface', () => {
    ...
    it('should show speaking indicator when agent speaks', async () => {
      ...
      await waitFor(() => {
        const indicator = screen.getByTestId('agent-speaking-indicator');
  ...
  describe('Two-Way Conversation Flow', () => {
    it('should handle complete conversation cycle', async () => {
      ...
      const userAudioLevel = screen.getByTestId('user-audio-level');
      ...
      await waitFor(() => {
        const agentIndicator = screen.getByTestId('agent-speaking-indicator');
