...
export default function GlobalLogoutModal({ open, onClose, onConfirm }: GlobalLogoutModalProps) {
  ...
  return (
    <>
      ...
      <div className="modal-overlay" ref={modalOverlayRef}>
        {/* Logout Modal */}
        <div className="login-modal logout-modal" ref={modalRef}>
          {/* Power Rail */}
          ...
          <div
            ...
            style={{ '--screw-index': 0 } as React.CSSProperties}
          ></div>
          <div
            className="screw screw-tr"
            style={{ '--screw-index': 1 } as React.CSSProperties}
          ></div>
          <div
            className="screw screw-bl"
            style={{ '--screw-index': 2 } as React.CSSProperties}
          ></div>
          <div
            className="screw screw-br"
            style={{ '--screw-index': 3 } as React.CSSProperties}
          ></div>
          ...
          <div className="logo-section">
            <div className="logo-icon">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                <defs>
                  <linearGradient id="sphereGradientLogout" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: '#f53969', stopOpacity: 1 }} />
                    <stop offset="100%" style={{ stopColor: '#ff6b35', stopOpacity: 1 }} />
                  </linearGradient>
                  <radialGradient id="jewelGradientLogout" cx="50%" cy="50%" r="50%">
                ...
                <circle
                  ...
                  r="24"
                  fill="none"
                  stroke="url(#sphereGradientLogout)"
                  strokeWidth="3"
                  opacity="0.8"
                />
          ...
          <div className={`loading-overlay ${isLoading ? 'active' : ''}`}>
            <svg className="loading-jewel" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
              <defs>
                <radialGradient id="loadingGradientLogout">
                  <stop offset="0%" style={{ stopColor: '#ffffff', stopOpacity: 1 }} />
                  <stop offset="30%" style={{ stopColor: '#f53969', stopOpacity: 1 }} />
                  <stop offset="60%" style={{ stopColor: '#ff6b35', stopOpacity: 1 }} />
                  <stop offset="100%" style={{ stopColor: '#f53969', stopOpacity: 0.9 }} />
              ...
              <circle
                ...
                r="20"
                fill="none"
                stroke="url(#loadingGradientLogout)"
                strokeWidth="4"
              />
              <circle cx="24" cy="24" r="10" fill="url(#loadingGradientLogout)" />
            </svg>
          </div>
        </div>
      </div>
