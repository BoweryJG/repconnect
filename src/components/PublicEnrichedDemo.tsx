...
export const PublicEnrichedDemo: React.FC = () => {
  ...
  const getStats = () => {
    return {
      ...
      avgRating: (contacts.reduce((sum, c) => sum + c.overallRating, 0) / contacts.length).toFixed(
        1
      ),
        ...
        >
          <div style={{ marginBottom: 32, textAlign: 'center' }}>
            ...
            <Alert severity="info" sx={{ maxWidth: 600, mx: 'auto' }}>
              This is a demo showcasing our enrichment capabilities. Sign up to enrich your own
              contacts!
            </Alert>
          </div>
        </motion.div>
