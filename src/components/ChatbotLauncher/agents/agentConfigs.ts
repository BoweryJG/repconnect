import { LucideIcon, Sparkles, Heart, Flower2, Sun, Gem, Smile, Crown, Star, Brain } from 'lucide-react';
...
export const agentConfigs: Record<string, AgentConfig> = {
  ...
  botox: {
    ...
    personality: {
      ...
      communicationPreferences: ['Clear explanations', 'Visual descriptions', 'Medical accuracy', 'Empathetic responses']
    },
    voiceConfig: {
  ...
  fillers: {
    ...
    personality: {
      ...
      communicationPreferences: ['Visual analogies', 'Artistic language', 'Detailed planning', 'Honest assessments']
    },
    voiceConfig: {
  ...
  skincare: {
    ...
    personality: {
      ...
      communicationPreferences: ['Scientific explanations', 'Step-by-step guidance', 'Product knowledge', 'Routine building']
    },
    voiceConfig: {
  ...
  laser: {
    ...
    personality: {
      ...
      communicationPreferences: ['Technical details', 'Treatment protocols', 'Expected outcomes', 'Safety information']
    },
    voiceConfig: {
  ...
  bodycontouring: {
    ...
    personality: {
      ...
      communicationPreferences: ['Motivational language', 'Realistic expectations', 'Progress tracking', 'Lifestyle integration']
    },
    voiceConfig: {
  ...
  implants: {
    ...
    personality: {
      ...
      communicationPreferences: ['Detailed explanations', 'Visual aids', 'Step-by-step process', 'Long-term planning']
    },
    voiceConfig: {
  ...
  orthodontics: {
    ...
    personality: {
      ...
      communicationPreferences: ['Positive reinforcement', 'Progress updates', 'Technology integration', 'Lifestyle considerations']
    },
    voiceConfig: {
  ...
  cosmetic: {
    ...
    personality: {
      ...
      communicationPreferences: ['Visual communication', 'Aesthetic language', 'Collaborative planning', 'Artistic expression']
    },
    voiceConfig: {
  ...
  harvey: {
    ...
    personality: {
      ...
      communicationPreferences: ['Medical accuracy', 'Comprehensive responses', 'Evidence-based', 'Professional terminology']
    },
    voiceConfig: {
...
export const getAgentsByCategory = (category: 'aesthetic' | 'dental' | 'general'): AgentConfig[] => {
