...
SELECT 'queued_calls table created' AS status WHERE EXISTS (SELECT FROM pg_tables WHERE tablename = 'queued_calls');
SELECT 'call_history table created' AS status WHERE EXISTS (SELECT FROM pg_tables WHERE tablename = 'call_history');